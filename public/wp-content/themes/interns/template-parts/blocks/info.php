...
if (!empty($is_preview)) :
    ...
    $imgUrl = get_stylesheet_directory_uri() . '/template-parts/preview/moreInfo.png';
    echo '<img src="' . $imgUrl . '">';
else:
    ...
    <div class="container py-4">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <a href="<?php echo $url; ?>" class="nav-link text-dark"><button type="button" class="btn btn-outline-dark"> <?php echo $button_title; ?> <i class="bi bi-arrow-right"></i></button>
            </a>
